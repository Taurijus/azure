...
function mapping.load()
	...
	mapping['wblock'] = {}
	mapping.wblock[1] = {img = love.graphics.newImage(pre.."Siena1.png"),
						offx = 753, offy = 1006, drawable = true}
	mapping.wblock[2] = {img = love.graphics.newImage(pre.."Siena2.png"),
						offx = 1030, offy = 957, drawable = true}
	mapping.wblock[3] = {img = love.graphics.newImage(pre.."Siena3.png"),
						offx = 1248, offy = 849, drawable = true}
	mapping.wblock[4] = {img = love.graphics.newImage(pre.."Siena4.png"),
						offx = 1358, offy = 734, drawable = true}
	mapping.wblock[5] = {img = love.graphics.newImage(pre.."Siena5.png"),
						offx = 1513, offy = 610, drawable = true}
	mapping.wblock[6] = {img = love.graphics.newImage(pre.."Siena6.png"),
						offx = 876, offy = 233, drawable = true}
	mapping.wblock[7] = {img = love.graphics.newImage(pre.."Siena7.png"),
						offx = 1445, offy = 449, drawable = true}
	mapping.wblock[8] = {img = love.graphics.newImage(pre.."Siena8.png"),
						offx = 341, offy = 345, drawable = true}
	mapping.wblock[9] = {img = love.graphics.newImage(pre.."Siena9.png"),
						offx = 383, offy = 653, drawable = true}
	mapping.wblock[10] = {img = love.graphics.newImage(pre.."Siena10.png"),
						offx = 881, offy = 396, drawable = true}
	mapping.wblock[11] = {img = love.graphics.newImage(pre.."Siena11.png"),
						offx = 760, offy = 499, drawable = true}
	mapping.wblock[12] = {img = love.graphics.newImage(pre.."Siena12.png"),
						offx = 469, offy = 599, drawable = true}
	mapping.wblock[13] = {img = love.graphics.newImage(pre.."Siena13.png"),
						offx = 644, offy = 722, drawable = true}
	mapping.wblock[14] = {img = love.graphics.newImage(pre.."Siena14.png"),
						offx = 793, offy = 875, drawable = true}
	mapping.wblock[15] = {img = love.graphics.newImage(pre.."Siena15.png"),
						offx = 1063, offy = 815, drawable = true}
	mapping.wblock[16] = {img = love.graphics.newImage(pre.."Siena16.png"),
						offx = 1086, offy = 725, drawable = true}
	mapping.wblock[17] = {img = love.graphics.newImage(pre.."Siena17.png"),
						offx = 1349, offy = 619, drawable = true}
...
function mapping.draw()
	...
	-- nice color my ass..
	for i = 1, #mapping.wblock do
		if mapping.wblock[i].drawable then
			love.graphics.draw(mapping.wblock[i].img,
					mapping.wblock[i].offx, mapping.wblock[i].offy)
		end
	end
	--[[
	for i = 1, #mapping.wall do
