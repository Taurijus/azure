...
function mapping.load()
	...
	mapping.image = love.graphics.newImage("images/9.png")
	mapping.imageSidesL = love.graphics.newImage("images/10.png")
	mapping.imageSidesR = love.graphics.newImage("images/10.png")
...
function mapping.draw()
	...
	love.graphics.draw(mapping.imageSidesL, mapping.x-2048, mapping.y)
	love.graphics.draw(mapping.imageSidesR, mapping.x+2048, mapping.y)
